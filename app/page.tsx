      ...
      <div>
        <div className="space-y-4 sm:space-y-5 md:space-y-6">
          ...
          <div className="mb-4 sm:mb-6 md:mb-8">
            <p className="text-[11px] sm:text-xs leading-relaxed text-gray-700 font-light max-w-3xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-5 md:mb-6">
            <div className="space-y-1 sm:space-y-2">
              ...
              <p className="text-[11px] sm:text-xs leading-relaxed text-gray-700 font-light">
