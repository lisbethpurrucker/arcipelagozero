    ...
    return (
      <div>
        <div className="space-y-6">
          {/* Hero text block */}
          <div className="mb-8">
            <p className="text-xs leading-relaxed text-gray-700 font-light max-w-3xl">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <div className="bg-teal-dark rounded-sm aspect-video flex items-center justify-center">
              <p className="text-white text-xs font-light">In terms consequat lorem ante in sit</p>
            </div>
          </div>
          ...
          {/* Large cream block */}
          <div className="bg-cream rounded-sm aspect-[2/1] mb-6"></div>
